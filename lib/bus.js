...
import { maybePromise } from './promisify.js';
...
import {
  declaration as propertyDeclaration,
  changedSignal as propertiesChangedSignal
} from './properties.js';
import * as objectManager from './object-manager.js';
import { createProxy } from './proxy.js';
import { ManagedObjects } from './managed-objects.js';
...
function bus(conn, opts) {
   ...
   * @returns {Promise<import('./managed-objects.js').ManagedObjects>}
   */
